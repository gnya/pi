...
* 最小公倍数で約分する方法を実装してみたけど良くならなかった（dictが悪い？）
* C^nを予め計算しておく方法も試したけどほとんど変わらなかった（piを求める部分で差し引き0になってしまう）
* 何か見落としているかもしれないけど、そろそろPythonから離れるときかも
* precisionをきちんと計算するようにしたのでちょこっと速くなった
